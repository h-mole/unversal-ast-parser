...
// EnterNewExpression_ is called when production newExpression_ is entered.
func (s *BaseCPP14ParserListener) EnterNewExpression_(ctx *NewExpression_Context) {}

// ExitNewExpression_ is called when production newExpression_ is exited.
func (s *BaseCPP14ParserListener) ExitNewExpression_(ctx *NewExpression_Context) {}
...
// EnterNewDeclarator_ is called when production newDeclarator_ is entered.
func (s *BaseCPP14ParserListener) EnterNewDeclarator_(ctx *NewDeclarator_Context) {}

// ExitNewDeclarator_ is called when production newDeclarator_ is exited.
func (s *BaseCPP14ParserListener) ExitNewDeclarator_(ctx *NewDeclarator_Context) {}
...
// EnterNewInitializer_ is called when production newInitializer_ is entered.
func (s *BaseCPP14ParserListener) EnterNewInitializer_(ctx *NewInitializer_Context) {}

// ExitNewInitializer_ is called when production newInitializer_ is exited.
func (s *BaseCPP14ParserListener) ExitNewInitializer_(ctx *NewInitializer_Context) {}
...
// EnterEmptyDeclaration_ is called when production emptyDeclaration_ is entered.
func (s *BaseCPP14ParserListener) EnterEmptyDeclaration_(ctx *EmptyDeclaration_Context) {}

// ExitEmptyDeclaration_ is called when production emptyDeclaration_ is exited.
func (s *BaseCPP14ParserListener) ExitEmptyDeclaration_(ctx *EmptyDeclaration_Context) {}
